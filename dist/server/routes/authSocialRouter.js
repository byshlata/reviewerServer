...
router.post("".concat(enums_1.Path.Root), authValidation_1.registerValidation, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, _a, email, login, password, avatar, userBase, _b, user, token, appSettings, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                _a = req.body, email = _a.email, login = _a.login, password = _a.password, avatar = _a.avatar;
                return [4 /*yield*/, (0, repository_1.getUserByEmail)(email)];
            case 1:
                userBase = _c.sent();
                if (!!userBase) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, repository_1.createUser)({ login: login, password: password, email: email, avatar: avatar })];
            case 2:
                userBase = _c.sent();
                _c.label = 3;
            case 3:
