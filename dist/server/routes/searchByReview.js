...
router.post("".concat(enums_1.Path.Root), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var query, searchResult, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                query = req.query;
                return [4 /*yield*/, (0, repositoryReview_1.searchByReview)(query[enums_1.QueryAPI.Search])];
            case 1:
                searchResult = _a.sent();
                return [2 /*return*/, res.send({ searchResult: searchResult })];
            case 2:
                error_1 = _a.sent();
