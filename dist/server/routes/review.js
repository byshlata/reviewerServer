...
router.get("".concat(enums_1.Path.Root).concat(enums_1.Path.Id), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, review, reviewSend, appSettings, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                appSettings = _a.sent();
                return [2 /*return*/, res.send({ appSettings: appSettings, review: reviewSend })];
            case 3:
                error_1 = _a.sent();
...
router["delete"]("".concat(enums_1.Path.Root), utils_1.checkAuth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, idSome, id, reviews, reviewsSend, appSettings, error_2;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                reviews = _b.sent();
                reviewsSend = (0, utils_1.createUserReviewsTableResponse)(reviews);
                return [4 /*yield*/, (0, repository_1.getAppSetting)()];
            case 2:
                appSettings = _b.sent();
